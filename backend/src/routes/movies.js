...
router.post('/', async (req, res) => {
    ...
    const insertedMovieRows = await client.query(
        ...
        [movieToAdd.title, movieToAdd.genre, movieToAdd.release_date, movieToAdd.description, movieToAdd.image_url, movieToAdd.director_id ? movieToAdd.director_id : null]
      );
...
router.patch('/:id/director', async (req, res) => {
    ...
    const id = req.params.id;
    console.log("router.patch:", id, directorToSet.id)
